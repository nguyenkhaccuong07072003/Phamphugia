  ...
  <div>
    ...
    <div class="w-full bg-[#d4ebdd] text-black h-10 flex items-center max-sm:hidden" style="font-size: 15px">
      <div class="w-full flex items-center justify-between" style="padding-left: 50px; padding-right: 50px">
        ...
        <div class="flex items-center gap-4">
          <a href="https://facebook.com/phamphugia" target="_blank"
            class="flex items-center gap-1.5 hover:text-[#f0a500] transition-colors">
    ...
    <div v-else
      class="w-full bg-linear-to-br from-[#0d2137] via-[#1a4a7a] to-[#0d2137] h-40 max-sm:h-20 flex items-center justify-center">
      <span
        class="text-5xl max-sm:text-2xl font-extrabold text-[#f0a500] tracking-[8px] max-sm:tracking-[4px] drop-shadow-lg">PHAM
        PHU GIA</span>
    </div>
  </div>
</template>
